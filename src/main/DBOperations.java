...
public class DBOperations {
	...
	private void insertFK(int itemID) {
		...
		Scanner reader = new Scanner(System.in);
		System.out.print(
				"The value {" + itemID + "} " + "does not exist in this table" + " would you like to create it [y/n]?");
		...
		while (!success) {
			...
			try {
				...
				if (e.getMessage().contains("Primary Key")) {
					System.out.println("The Item Name {" + itemName + "}" + " already exists Please enter a new one");
					System.out.print("\t Item Name[STRING]:");
					itemName = reader.nextLine();
				}
				success = false;
